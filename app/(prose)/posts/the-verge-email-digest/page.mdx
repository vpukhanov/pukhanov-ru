...
<Figure
  src={followTopicsImg}
  alt="A panel saying, 'Follow topics and authors from this story to see more like this in your personalized homepage feed and to receive email updates.' Under the panel are four checkboxes, saying 'David Pearce', 'Apple', 'iPad' and 'Tech'."
/>
