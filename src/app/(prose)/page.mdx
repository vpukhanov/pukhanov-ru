export const metadata = {
  description:
    "I'm a Lead Frontend Engineer at Tinkoff, where we create the best media about finance, life and experiences - Tinkoff Journal. This is a personal website where I express my opinions and views exclusively.",
};
...
- My work on the Node.js backend of the site lets it handle visits from 20+ million readers per month without crashing
- I keep an eye on front-end performance metrics and make optimizations as needed. Raised the percentage of effective pages according to Google from 10% to 90%
